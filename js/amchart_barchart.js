...
function cumulative_data(){
  console.log('bar-cahrat',globals);
...
globals.chart.dataSource.parser.options.numberFields = ["Total Beds Avail","Total Vent. Avail","Total Staff Avail"];

globals.chart.dataSource.events.on("parseended", function(ev) {
  console.log('ev-barchart',ev,'ev.target.data',ev.target.data);
  var data = ev.target.data;
  for (var i = 0; i < data.length; i++) {
    if(data[i]["Total Staff Avail"] == "NA") {
      data[i]["Total Staff Avail"] = 1 ;
    }
    data[i]["activeCount"] = data[i]["Total Beds Avail"] - data[i]["Total Vent. Avail"] - data[i]["Total Staff Avail"];
  }
});
...
series3.dataFields.valueY = "Total Staff Avail";
...
series2.dataFields.valueY = "Total Vent. Avail";
...
series.dataFields.valueY = "Total Beds Avail";
...
console.log('bar-cahra-end',globals,"globals.chart-new",globals.chart );
}
...
//   for (var i = 0; i < data.length; i++) {
//     if (data[i]["Total Beds Avail"] == 0) {
//       data[i]["Total Beds Avail"] = 1;
//     }
//     if (data[i]["Total Vent. Avail"] == 0) {
//       data[i]["Total Vent. Avail"] = 1;
//     }
//     if (data[i]["Total Staff Avail"] == 0 || data[i]["Total Staff Avail"] == "NA") {
//       data[i]["Total Staff Avail"] = 1;
//     }
//     data[i]["activeCount"] = parseInt(data[i]["Total Beds Avail"]) - parseInt(data[i]["Total Vent. Avail"]) - parseInt(data[i]["Total Staff Avail"]);

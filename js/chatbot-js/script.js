...
function setUserResponse(message) {
    var UserResponse = '<img class="userAvatar" src=' + "./images/chatbot-img/userAvatar.jpg" + '><p class="userMsg">' + message + ' </p><div class="clearfix"></div>';
...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var BotResponse = '<img class="botAvatar" src="./images/chatbot-img/botAvatar.svg"/><p class="botMsg">' + fallbackMsg + '</p><div class="clearfix"></div>';
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (response[i].hasOwnProperty("text")) {
                    var BotResponse = '<img class="botAvatar" src="./images/chatbot-img/botAvatar.svg"/><p class="botMsg">' + response[i].text + '</p><div class="clearfix"></div>';
                    $(BotResponse).appendTo(".chats").hide().fadeIn(1000);
                ...
                if (response[i].hasOwnProperty("custom")) {
                    ...
                    var chatResponse = response[i].custom;

                    if (typeof chatResponse !== 'undefined') {
                        jsonData1 = JSON.parse(chatResponse);

                    }
                    formDataTable(jsonData1);
...
function addSuggestion(textToAdd) {
    setTimeout(function() {
        ...
        for (i = 0; i < suggLength; i++) {
            if (suggestions[i].title == "Back to Main Menu") {
                $('<div class="backmenuChips" data-payload=\'' + (suggestions[i].payload) + '\'>' + suggestions[i].title + "</div>").appendTo(".menu");
            } else
...
$(document).on("click", ".menu .backmenuChips", function() {
    var text = this.innerText;
    var payload = this.getAttribute('data-payload');
    console.log("payload: ", this.getAttribute('data-payload'))
    setUserResponse(text);
...
function showBotTyping() {
    ...
    var botTyping = '<img class="botAvatar" id="botAvatar" src="./images/chatbot-img/botAvatar.svg"/><div class="botTyping">' + '<div class="bounce1"></div>' + '<div class="bounce2"></div>' + '<div class="bounce3"></div>' + '</div>'
...
function formDataTable(response) {
    ...
    var $table = $('<img class="botAvatar" src="./images/chatbot-img/botAvatar.svg"/><table class="custom_class" style="background-color:rgb(190,190,190);border: 1px solid black;">');
    ...
    $($table).appendTo(".chats").hide().fadeIn(1000);
    $('.usrInput').focus();
}
...
-- 	By Shirish P. Dumbre
-- 
--table 1:  usa_va_mrdd_vhass.
CREATE TABLE IF NOT EXISTS :current_schema.usa_va_mrdd_vhass
(
...
-- table 2:  usa_va_mrdd_scenarios.
CREATE TABLE IF NOT EXISTS :current_schema.usa_va_mrdd_scenarios
(
...
-- table 3:  usa_va_mrdd_data.
CREATE TABLE IF NOT EXISTS :current_schema.usa_va_mrdd_data
(
	id SERIAL,
